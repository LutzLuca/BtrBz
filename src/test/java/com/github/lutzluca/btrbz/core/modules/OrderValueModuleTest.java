...
class OrderValueModuleTest {

    @Nested
    @DisplayName("order value breakdown")
    class OrderValueBreakdownCalculation {
        ...
        void separatesLockedPendingAndClaimableValues() {
            ...
            assertEquals(30.0, breakdown.lockedInBuyOrders());
            assertEquals(22.0, breakdown.itemsFromBuyOrders());
            assertEquals(24.0, breakdown.coinsFromSellOffers());
            assertEquals(35.0, breakdown.pendingSellOffers());
