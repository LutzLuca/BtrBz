...
public final class BazaarMessageDispatcher {
    ...
    private <T extends BazaarMessage> void dispatch(T msg) {
        ...
        Optional.ofNullable(this.listeners.get(msg.getClass()))
            .ifPresent(
                listeners -> listeners.forEach(
                    listener -> Try.run(() -> ((Consumer<T>) listener).accept(msg))
                        .onFailure(
                            err -> log.error(
    ...
    public void handleChatMessage(String msg) {
        ...
        OrderInfoParser.parseBazaarMessage(msg)
            .onSuccess(this::dispatch);
    }

    public sealed interface BazaarMessage permits BazaarMessage.OrderSetup, BazaarMessage.OrderFilled,
        BazaarMessage.InstaSell, BazaarMessage.InstaBuy, BazaarMessage.OrderFlipped {
        ...
        record OrderSetup(OrderType type, int volume, String productName, double total) implements BazaarMessage {}

        record OrderFilled(OrderType type, int volume, String productName) implements BazaarMessage {}
        ...
        record OrderFlipped(int volume, String productName, double profit) implements BazaarMessage {}
    }
}
