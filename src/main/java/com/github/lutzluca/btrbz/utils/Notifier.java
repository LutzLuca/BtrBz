...
public class Notifier {
    ...
    public static void notifyOrderStatus(StatusUpdate update, BazaarData bazaarData) {
        ...
        MutableComponent msg = switch (status) {
            case Top _ -> {
                ...
                yield update.prev() instanceof OrderStatus.Unknown
                    ? singleMsg(
                        order,
                        cfg,
                        Component.literal("is the ")
                            .withStyle(ChatFormatting.GRAY)
                            .append(
                                Component.literal("BEST Order!")
                    ...
                    : singleMsg(
                        ...
                        Component.literal("has ")
                            .withStyle(ChatFormatting.GRAY)
                            .append(
                                Component.literal("REGAINED BEST Order!")
                                    .withStyle(ChatFormatting.GREEN)
                            )
                    );
            }
            case Matched _ -> {
                ...
                var matchedMsg = singleMsg(
                    order,
                    cfg,
                    Component.literal("was ")
                        .withStyle(ChatFormatting.GRAY)
                        .append(
                            Component.literal("MATCHED!")
            ...
            case Undercut undercut -> {
                ...
                var undercutMsg = singleMsg(
                    order,
                    cfg,
                    Component.literal("was ")
                        .withStyle(ChatFormatting.GRAY)
                        .append(
                            Component.literal("UNDERCUT ")
                                .withStyle(ChatFormatting.RED)
                        )
                        .append(
                            Component.literal("by ")
                                .withStyle(ChatFormatting.GRAY)
                        )
                        .append(
                            Component.literal(Utils.formatDecimal(undercut.amount, 1, true) + " coins!")
    ...
    public static void notifyGroupOrderStatus(
        ...
        int totalVolume = allOrders.stream()
            .mapToInt(o -> o.volume)
            .sum();
        ...
        MutableComponent msg = switch (curr) {
            case GroupStatus.Undercut undercut -> {
                SoundUtil.playSoundIf(cfg.soundUndercut, SoundEvents.EXPERIENCE_ORB_PICKUP, 0.5f, 2);
                var undercutMsg = groupMsg(
                    key,
                    groupSize,
                    totalVolume,
                    cfg,
                    Component.literal("were ")
                        .withStyle(ChatFormatting.GRAY)
                        .append(
                            Component.literal("UNDERCUT ")
                                .withStyle(ChatFormatting.RED)
            ...
            case GroupStatus.SelfMatched _ -> {
                ...
                yield groupMsg(
                    ...
                    Component.literal("were ")
                        .withStyle(ChatFormatting.GRAY)
                        .append(
                            Component.literal("SELF-MATCHED!")
                                .withStyle(ChatFormatting.BLUE)
                        )
                );
            }
    ...
    private static MutableComponent singleMsg(TrackedOrder order, OrderManagerConfig cfg, Component statusPart) {
        ...
        var msg = prefix().append(
            Component.literal("Your ")
                .withStyle(ChatFormatting.GRAY)
        )
            .append(
                Component.literal(orderString)
            ...
            .append(
                Component.literal(order.volume + "x")
            ...
            .append(
                Component.literal(order.productName)
    ...
    private static MutableComponent groupMsg(
        ...
        var msg = prefix().append(
            ...
            .append(
                Component.literal(totalVolume + "x total")
                    .withStyle(ChatFormatting.LIGHT_PURPLE)
            )
            .append(
                Component.literal(" ")
            ...
            .append(
                Component.literal(key.productName())
                    .withStyle(ChatFormatting.YELLOW)
            );
        ...
        if (cfg.includePricePerUnit) {
            msg.append(
                ...
                .append(
                    Component.literal(Utils.formatDecimal(key.pricePerUnit(), 1, true))
                        .withStyle(ChatFormatting.GOLD)
                )
                .append(
                    Component.literal(" coins")
    ...
    private static void applyGotoAction(MutableComponent msg, Action action, String productName) {
        if (action == Action.Item) {
            msg.append(
                Component.literal(" [Go To Item]")
                    .withStyle(ChatFormatting.DARK_AQUA)
                    .withStyle(
                        style -> style.withClickEvent(new RunCommand("/bz " + productName))
                            .withHoverEvent(
                                new ShowText(
                                    Component.empty()
                                        .append(
                                        ...
                                        .append(
                                            Component.literal(" in the Bazaar")
                                                .withStyle(ChatFormatting.GRAY)
                                        )
                                )
                            )
    ...
    public static void notifySelfUndercut(SelfUndercutKey key, double bestPrice, double secondBestPrice) {
        ...
        var msg = prefix().append(
            ...
            .append(
                Component.literal("SELF-UNDERCUT")
                    .withStyle(ChatFormatting.RED)
            )
            .append(
            ...
            .append(
                Component.literal(Utils.formatDecimal(bestPrice, 1, true))
                    .withStyle(ChatFormatting.GOLD)
            )
            .append(
            ...
            .append(
                Component.literal(Utils.formatDecimal(secondBestPrice, 1, true))
                    .withStyle(ChatFormatting.GOLD)
            )
            .append(
                Component.literal(" coins")
    ...
    public static void notifyAlertRegistered(ResolvedAlertArgs cmd) {
        var msg = prefix().append(
            Component.literal("Alert registered. ")
                .withStyle(ChatFormatting.GREEN)
        )
            .append(
                Component.literal("You will be informed once the ")
                    .withStyle(ChatFormatting.GRAY)
            )
            .append(
                Component.literal(
            ...
            .append(
                Component.literal(" price of ")
                    .withStyle(ChatFormatting.GRAY)
            )
            .append(
                Component.literal(cmd.productName())
                    .withStyle(ChatFormatting.GOLD)
            )
            .append(
                Component.literal(" reaches ")
                    .withStyle(ChatFormatting.GRAY)
            )
            .append(
                Component.literal(Utils.formatDecimal(cmd.price(), 1, true) + " coins")
                    .withStyle(ChatFormatting.YELLOW)
            );
    ...
    public static void notifyPriceReached(Alert alert, Optional<Double> price) {
        ...
        String priceText = price.map(p -> Utils.formatDecimal(p, 1, true) + " coins. ")
            .orElse("currently has no listed price. ");

        Component msg = prefix().append(
            Component.literal("Your alert for ")
                .withStyle(ChatFormatting.GRAY)
        )
            .append(
                Component.literal(alert.productName)
                    .withStyle(ChatFormatting.GOLD)
            )
            .append(
                Component.literal(" at ")
            ...
            .append(
                Component.literal(Utils.formatDecimal(alert.price, 1, true) + "coins")
                    .withStyle(ChatFormatting.YELLOW)
            )
            .append(
                Component.literal(" (" + alert.type.format() + ") ")
                    .withStyle(ChatFormatting.DARK_GRAY)
            )
            .append(
                Component.literal("has been reached")
                    .withStyle(ChatFormatting.GREEN)
            )
            .append(
                Component.literal(" and is ")
                    .withStyle(ChatFormatting.GRAY)
            )
            .append(
            ...
            .append(
                Component.literal("[Click to view]")
                    .withStyle(
                        style -> style.withClickEvent(new RunCommand("/bz " + alert.productName))
                            .withHoverEvent(
                                new ShowText(
                                    Component.literal("Click to go to " + alert.productName + " in the bazaar")
                                )
                            )
                    )
                    .withStyle(ChatFormatting.RED)
    ...
    public static void notifyAlertAlreadyPresent(ResolvedAlertArgs args) {
        Component msg = prefix().append(
            Component.literal("You already have an alert for ")
                .withStyle(ChatFormatting.GRAY)
        )
            .append(
                Component.literal(args.productName())
                    .withStyle(ChatFormatting.GOLD)
            )
            .append(
                Component.literal(" at ")
            ...
            .append(
                Component.literal(Utils.formatDecimal(args.price(), 1, true))
                    .withStyle(ChatFormatting.YELLOW)
            )
            .append(
                Component.literal(
            ...
            .append(
                Component.literal("/btrbz alert list")
                    .withStyle(ChatFormatting.AQUA)
            )
            .append(
                Component.literal(" to view them")
                    .withStyle(ChatFormatting.GRAY)
            );
    ...
    public static void notifyInvalidProduct(Alert alert) {
        Component msg = prefix().append(
            Component.literal("The price of ")
                .withStyle(ChatFormatting.GRAY)
        )
            .append(
                Component.literal(alert.productName)
            ...
            .append(
                Component.literal(" could not be determined. ")
                    .withStyle(ChatFormatting.GRAY)
            )
    ...
    public static void notifyOutdatedAlert(Alert alert, String durationText) {
        Component msg = prefix().append(
            ...
            .append(
                Component.literal(Utils.formatDecimal(alert.price, 1, true))
                    .withStyle(ChatFormatting.YELLOW)
            )
            .append(
                Component.literal(" has not been reached for " + durationText + ". ")
                    .withStyle(ChatFormatting.GRAY)
            )
    ...
    public static Component clickToRemoveAlert(UUID id, String hoverText) {
        return Component.literal("[Click to remove]")
            .withStyle(
                style -> style.withClickEvent(new RunCommand("/btrbz alert remove " + id))
    ...
    public static void notifyChatCommand(String displayText, String cmd) {
        MutableComponent msg = Component.literal(displayText)
            .withStyle(
                style -> style.withClickEvent(new RunCommand("/" + cmd))
    ...
    public static void sendBlockedOrderMessage(ValidationResult validation) {
        var reason = validation.reason() == null ? "Order blocked." : "Order blocked: " + validation.reason();

        var msg = Component.literal(reason)
            .withStyle(ChatFormatting.RED)
            .append(
    ...
    public static MutableComponent prefix() {
        return Component.literal("[BtrBz] ")
            .withStyle(ChatFormatting.GOLD);
    }
}
