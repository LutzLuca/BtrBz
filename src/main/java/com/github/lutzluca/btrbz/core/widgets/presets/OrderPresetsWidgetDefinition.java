...
import com.github.lutzluca.btrbz.core.widgets.presets.OrderPresetsWidgetData.Snapshot;
...
public final class OrderPresetsWidgetDefinition {
    ...
    public static WidgetDefinition<Snapshot, OrderPresetsWidgetConfig, OrderPresetsAction> create(
        ...
        return WidgetDefinition.<Snapshot, OrderPresetsWidgetConfig, OrderPresetsAction>builder(
            ID, "Presets")
            ...
            .data(data)
            .cachePrepared()
            .preview(() -> new WidgetPreview<>(OrderPresetsWidgetData.preview(),
                WidgetPreviewSessions.container(BazaarMenuType.BuyOrderSetupVolume), "default"))
